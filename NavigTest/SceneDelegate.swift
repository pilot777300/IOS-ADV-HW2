...
//       lvc.signUp = false
   ...
   profileViewController.tabBarItem = UITabBarItem(title: NSLocalizedString("Map", comment: ""), image: UIImage(systemName: "mappin"), tag: 1)
        profileViewController.title = NSLocalizedString("Map", comment: "")
